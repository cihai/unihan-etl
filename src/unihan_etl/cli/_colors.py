...
>>> colors.success("exported")  # doctest: +ELLIPSIS
'...'
...
class Colors:
    ...
    --------
    >>> colors = Colors(ColorMode.NEVER)
    >>> colors.success("exported 93858 characters")
    'exported 93858 characters'
    >>> colors.error("failed to download")
    'failed to download'
    ...
    SUCCESS = "green"  # Success, exported, downloaded
    WARNING = "yellow"  # Warnings, deprecation notices
    ERROR = "red"  # Errors, failures
    INFO = "cyan"  # Information, paths, supplementary
    HEADING = "bright_cyan"  # Section headers
    HIGHLIGHT = "magenta"  # Important labels, field names
    ...
    def warning(self, text: str, bold: bool = False) -> str:
        ...
        --------
        >>> colors = Colors(ColorMode.NEVER)
        >>> colors.warning("deprecated field")
        'deprecated field'
        """
    ...
    def heading(self, text: str) -> str:
        ...
        Used for section headers like 'Fields:' or 'Examples:'.
        ...
        --------
        >>> colors = Colors(ColorMode.NEVER)
        >>> colors.heading("Available Fields:")
        'Available Fields:'
        """
    ...
    def format_path(self, path: str) -> str:
        ...
        --------
        >>> colors = Colors(ColorMode.NEVER)
        >>> colors.format_path("~/data/unihan.json")
        '~/data/unihan.json'
        """
...
# ANSI styling utilities (originally from click)
