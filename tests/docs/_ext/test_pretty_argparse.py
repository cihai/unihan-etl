...
ESCAPE_RST_EMPHASIS_FIXTURES: list[EscapeRstEmphasisFixture] = [
    EscapeRstEmphasisFixture(
        ...
        input_text='unihan-etl export "cjk-*"',
        expected='unihan-etl export "cjk-\\*"',
    ),
    EscapeRstEmphasisFixture(
        test_id="multiple_glob_patterns",
        input_text='unihan-etl export "cjk-*" "kp-*"',
        expected='unihan-etl export "cjk-\\*" "kp-\\*"',
    ),
    EscapeRstEmphasisFixture(
        test_id="plain_text_unchanged",
        input_text="unihan-etl export",
        expected="unihan-etl export",
    ),
    EscapeRstEmphasisFixture(
    ...
    EscapeRstEmphasisFixture(
        ...
        input_text='Filter by "cjk-*',
        expected='Filter by "cjk-\\*',
    ),
    EscapeRstEmphasisFixture(
...
def test_transform_definition_list_single_examples() -> None:
    ...
    dl += _make_dl_item("examples:", "unihan-etl --help")
...
def test_transform_definition_list_nested_examples() -> None:
    ...
    dl = nodes.definition_list()
    dl += _make_dl_item("examples:", "unihan-etl --help")
    dl += _make_dl_item("Machine-readable output examples:", "unihan-etl -F json")
...
def test_transform_definition_list_multiple_categories() -> None:
    ...
    dl = nodes.definition_list()
    dl += _make_dl_item("examples:", "unihan-etl --help")
    dl += _make_dl_item("Field-scoped examples:", "unihan-etl -f kDefinition")
    dl += _make_dl_item("Machine-readable output examples:", "unihan-etl -F json")
